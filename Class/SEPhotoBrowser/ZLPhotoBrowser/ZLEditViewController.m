...
- (void)viewDidLayoutSubviews
{
    ...
    if (hideClipRatioView) {
        ...
        _rotateRatioBtn.superview.frame = CGRectMake(kWidth-40-inset.right, kHeight-168-inset.bottom, 40, 40);
        _rotateRatioBtn.sd_layout
        .spaceToSuperView(UIEdgeInsetsMake(70, 0, 0, 0));
        [_rotateRatioBtn setCornerRadius:3];
