...
typedef void(^ShowSuccessBlock)(void);

typedef void(^SelectPhotoImageBlock)(NSArray<UIImage *> *images, NSArray<PHAsset *> *assets, BOOL isOriginal);
 ...
 */
@property (nonatomic, copy) SelectPhotoImageBlock selectPhotoImageBlock;
