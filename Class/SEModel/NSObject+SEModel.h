 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `SEModel` protocol for custom methods.
 ...
 */
@interface NSDictionary (SEModel)
...
/**
 ...
 There's no need to add '<SEModel>' to your class header.
 */
@protocol SEModel <NSObject>
@optional
