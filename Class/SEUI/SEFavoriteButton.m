...
#import "SEFavoriteButton.h"


@interface SEFavoriteButton ()
...
@end
@implementation SEFavoriteButton
...
- (void)createLayersWithImage:(UIImage *)image {
    ...
    CGRect imageFrame = CGRectMake(self.frame.size.width*0.3 - self.frame.size.width / 4+1.5,
                                   self.frame.size.height*0.4 - self.frame.size.height / 4-2.5,
